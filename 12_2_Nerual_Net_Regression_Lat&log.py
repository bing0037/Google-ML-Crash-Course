# Modified from 12_improving_Neural_Net_performance.py
# To test the relationship between housing price and latitude and longitude(Verify if the location of the house determines the price).
...
# california_housing_dataframe = pd.read_csv("https://storage.googleapis.com/mledu-datasets/california_housing_test.csv", sep=",")
# Data Extraction:
