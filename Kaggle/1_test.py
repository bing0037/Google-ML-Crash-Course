...
# Data:
Titanic_dataframe = pd.read_csv("/home/roboticslab16/code/study/Google ML Crash Course/Kaggle/california_housing_train.csv", sep=",")
...
def preprocess_targets(Titanic_dataframe):
    ...
    output_targets["median_house_value_is_high"] = (
        Titanic_dataframe["Fare"] > 50).astype(float)
